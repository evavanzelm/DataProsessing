...
*/
// margins
var margin = {top: 30, right: 600, bottom: 80, left: 65},
...
var parseDate = d3.time.format("%Y%m%d").parse;
    ...
    formatAverage = function(d) { return "average: " + formatValue(d) + "\xB0C \n"; }
    formatMin = function(d) { return  "min: " + formatValue(d) + "\xB0C \n"; }
    formatMax = function(d) { return "max: " + formatValue(d) + "\xB0C"; }
...
d3.json("data.json", function(data) {
  ...
  y.domain([-10, d3.max(data, function(data) { return data.max; })]);
    ...
    var focus2 = svg.append("g")
      ...
      focus2.attr("transform", "translate(" + x(d.date) + "," + y(d.average) + ")");

      focus2.select("text")
        .html(formatAverage(d.average) + '<br>' + formatMin(d.min) +'<br>' +  formatMax(d.max))
