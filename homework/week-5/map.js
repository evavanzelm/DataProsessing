    ...
    for (var i = 0; i < data.length; i++){
        ...
        for (var j =0; j < country_codes.length; j++){
            if (data[i].Country == country_codes[j][2]){
                data[i].Country = country_codes[j][1] 
            }
        }

        // make a new array with the fill color and the data 
        if (data[i].Data < 10){
            countryColor[data[i].Country] = { fillKey : "a", data : data[i].Data}
        }
        else if (data[i].Data < 20){
            countryColor[data[i].Country] = { fillKey : "b", data : data[i].Data}
        }
        else if (data[i].Data < 30){
            countryColor[data[i].Country] = { fillKey : "c", data : data[i].Data}
        }
        else if (data[i].Data < 40){
            countryColor[data[i].Country] = { fillKey : "d", data : data[i].Data}
        }
        else if (data[i].Data < 50){
            countryColor[data[i].Country] = { fillKey : "e", data : data[i].Data}
        }
